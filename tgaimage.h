...
struct TGAColor {
    ...
    const std::uint8_t& r() const { return bgra[2]; }
    const std::uint8_t& g() const { return bgra[1]; }
    const std::uint8_t& b() const { return bgra[0]; }
    const std::uint8_t& a() const { return bgra[3]; }
};
...
struct TGAImage {
    ...
    const std::vector<std::uint8_t>& Data() const { return data; }
private:
